...
ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4387__auto__,k25933,else__4388__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k25933,else__4388__auto__);
...
return (function (ret__4407__auto__,p__25938){
var vec__25939 = p__25938;
var k__4408__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25939,(0),null);
var v__4409__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25939,(1),null);
...
ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__25932){
var self__ = this;
var G__25932__$1 = this;
return (new cljs.core.RecordIter((0),G__25932__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
var h__4243__auto____$1 = (function (){var fexpr__25942 = ((function (h__4243__auto__,this__4381__auto____$1){
return (function (coll__4382__auto__){
return (-473222333 ^ cljs.core.hash_unordered_coll(coll__4382__auto__));
});})(h__4243__auto__,this__4381__auto____$1))
;
return fexpr__25942(this__4381__auto____$1);
})();
...
ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this25934,other25935){
var self__ = this;
var this25934__$1 = this;
return (((!((other25935 == null)))) && ((this25934__$1.constructor === other25935.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this25934__$1.status,other25935.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this25934__$1.body,other25935.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this25934__$1.status_text,other25935.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this25934__$1.headers,other25935.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this25934__$1.was_aborted,other25935.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this25934__$1.__extmap,other25935.__extmap)));
});
...
ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4392__auto__,k__4393__auto__,G__25932){
var self__ = this;
var this__4392__auto____$1 = this;
var pred__25943 = cljs.core.keyword_identical_QMARK_;
var expr__25944 = k__4393__auto__;
if(cljs.core.truth_((function (){var G__25946 = new cljs.core.Keyword(null,"status","status",-1997798413);
...
return (new ajax.protocols.Response(G__25932,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__25948 = new cljs.core.Keyword(null,"body","body",-2049205669);
...
return (new ajax.protocols.Response(self__.status,G__25932,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__25950 = new cljs.core.Keyword(null,"status-text","status-text",-1834235478);
...
return (new ajax.protocols.Response(self__.status,self__.body,G__25932,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__25952 = new cljs.core.Keyword(null,"headers","headers",-835030129);
...
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__25932,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__25954 = new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828);
...
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__25932,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4393__auto__,G__25932),null));
}
}
}
}
...
ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4384__auto__,G__25932){
var self__ = this;
var this__4384__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__25932,self__.__extmap,self__.__hash));
});
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__25936){
var extmap__4424__auto__ = (function (){var G__25956 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__25936,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__25936)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__25956);
} else {
return G__25956;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__25936),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__25936),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__25936),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__25936),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__25936),null,cljs.core.not_empty(extmap__4424__auto__),null));
});
