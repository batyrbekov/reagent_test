...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__26535 = cljs.core.second(format);
var G__26536 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__26535,G__26536) : ajax.easy.keyword_response_format_element.call(null,G__26535,G__26536));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26541_SHARP_){
return ajax.easy.keyword_response_format_element(p1__26541_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__26550){
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26551__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26551__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26551__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return ((function (h,e,map__26551,map__26551__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__26553){
var vec__26554 = p__26553;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26554,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26554,(1),null);
var fexpr__26557_26580 = (cljs.core.truth_(ok)?h:e);
(fexpr__26557_26580.cljs$core$IFn$_invoke$arity$1 ? fexpr__26557_26580.cljs$core$IFn$_invoke$arity$1(result) : fexpr__26557_26580.call(null,result));
...
;})(h,e,map__26551,map__26551__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__26558){
var map__26559 = p__26558;
var map__26559__$1 = (((((!((map__26559 == null))))?(((((map__26559.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__26559.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__26559):map__26559);
var opts = map__26559__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26559__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26559__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26559__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26559__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26559__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
