...
var G__37535 = o;
(G__37535[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__37567__delegate = function (args){
...
while (G__37568__i < G__37568__a.length) {G__37568__a[G__37568__i] = arguments[G__37568__i + 0]; ++G__37568__i;}
  args = new cljs.core.IndexedSeq(G__37568__a,0,null);
} 
return G__37567__delegate.call(this,args);};
...
return G__37567__delegate(args);
});
...
var G__37536 = o;
(G__37536[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__37571__i < G__37571__a.length) {G__37571__a[G__37571__i] = arguments[G__37571__i + 0]; ++G__37571__i;}
  args = new cljs.core.IndexedSeq(G__37571__a,0,null);
} 
...
var args = cljs.core.seq(arglist__37572);
...
var G__37538 = props;
var G__37538__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37538,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37538);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37538__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__37539){
...
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37540__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__37542){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37543__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__37543,map__37543__$1,on_write){
return (function (){
...
});})(node_value,map__37543,map__37543__$1,on_write))
);
} else {
...
var G__37546 = jsprops;
(G__37546["defaultValue"] = value);

(G__37546["onChange"] = ((function (G__37546,v,value,on_change){
return (function (p1__37545_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__37545_SHARP_);
});})(G__37546,v,value,on_change))
);
...
var vec__37548 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37548,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37548,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37548,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___37587 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___37587 == null)){
} else {
var key_37588 = temp__5724__auto___37587;
(jsprops["key"] = key_37588);
}
...
var temp__5724__auto___37589 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___37589 == null)){
} else {
var key_37590 = temp__5724__auto___37589;
reagent.impl.template.oset(jsprops,"key",key_37590);
}
...
var G__37552 = reagent.impl.template.__GT_NativeWrapper();
(G__37552["name"] = c);
...
var G__37553 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__37553) : reagent.impl.template.as_element.call(null,G__37553));
} else {
...
args__4736__auto__.push((arguments[i__4731__auto___37593]));
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq37556){
var G__37557 = cljs.core.first(seq37556);
var seq37556__$1 = cljs.core.next(seq37556);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37557,seq37556__$1);
});
...
break;
default:
var G__37599 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__37599;
continue;
...
var n__4607__auto___37608 = a.length;
var i_37609 = (0);
while(true){
if((i_37609 < n__4607__auto___37608)){
(a[i_37609] = reagent.impl.template.as_element((a[i_37609])));

var G__37610 = (i_37609 + (1));
i_37609 = G__37610;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___37611 = a.length;
var i_37612 = (0);
while(true){
if((i_37612 < n__4607__auto___37611)){
var val_37613 = (a[i_37612]);
if(((cljs.core.vector_QMARK_(val_37613)) && ((reagent.impl.template.key_from_vec(val_37613) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_37612] = reagent.impl.template.as_element(val_37613));

var G__37615 = (i_37612 + (1));
i_37612 = G__37615;
continue;
} else {
}
...
var ctx = ({});
var vec__37560 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37560,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37560,(1),null);
...
var G__37563 = (cljs.core.count(argv) - first_child);
switch (G__37563) {
case (0):
...
case (1):
var G__37564 = comp;
var G__37565 = jsprops;
var G__37566 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__37564,G__37565,G__37566);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__37563){
