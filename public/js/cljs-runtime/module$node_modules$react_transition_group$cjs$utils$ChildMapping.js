shadow$provide.module$node_modules$react_transition_group$cjs$utils$ChildMapping=function(global,process,require,module,exports,shadow$shims){function getChildMapping(children,mapFn){var result=Object.create(null);children&&_react.Children.map(children,function(c){return c}).forEach(function(child){var JSCompiler_temp_const=child.key;child=mapFn&&(0,_react.isValidElement)(child)?mapFn(child):child;result[JSCompiler_temp_const]=child});return result}function mergeChildMappings(prev,next){function getValueForKey(key){return key in
