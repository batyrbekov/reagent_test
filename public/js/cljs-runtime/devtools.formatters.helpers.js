...
var G__29332 = devtools.prefs.pref(v);
v = G__29332;
continue;
} else {
return v;
...
}catch (e29248){var _e__26449__auto__ = e29248;
return false;
}})();
...
}catch (e29252){var _e__26449__auto__ = e29252;
return false;
}})();
...
}catch (e29254){var _e__26449__auto__ = e29254;
return false;
}}
}
});
...
var vec__29261 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29261,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29261,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__29305_SHARP_);
}),template);
});
