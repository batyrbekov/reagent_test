...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq29456){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29457,G__29458,seq29456__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__29464_SHARP_){
return (!((cljs.core.meta(p1__29464_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29536__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e29540){var _e__26449__auto__ = e29540;
return false;
}})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
}catch (e29542){var _e__26449__auto__ = e29542;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__29544 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__29545 = devtools.formatters.state.get_current_state();
devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__29545;

try{var map__29546 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29546__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__29544;
}});
...
;
var temp__5718__auto___29713 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5718__auto___29713)){
var managed_print_level_29714 = temp__5718__auto___29713;
var _STAR_print_level_STAR__orig_val__29559_29715 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__29560_29716 = managed_print_level_29714;
cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29560_29716;

try{devtools.formatters.state.update_current_state_BANG_(((function (_STAR_print_level_STAR__orig_val__29559_29715,_STAR_print_level_STAR__temp_val__29560_29716,managed_print_level_29714,temp__5718__auto___29713,writer,opts,job_fn){
return (function (p1__29554_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__29554_SHARP_,null);
});})(_STAR_print_level_STAR__orig_val__29559_29715,_STAR_print_level_STAR__temp_val__29560_29716,managed_print_level_29714,temp__5718__auto___29713,writer,opts,job_fn))
);

job_fn();
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29559_29715;
}} else {
job_fn();
}
