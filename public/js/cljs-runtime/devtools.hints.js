...
var G__26628 = cljs.core.PersistentArrayMap.EMPTY;
var G__26629 = native_stack_trace;
var G__26630 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__26631 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__26628,G__26629,G__26630,G__26631) : cljs.stacktrace.parse_stacktrace.call(null,G__26628,G__26629,G__26630,G__26631));
});
...
}catch (e26638){var _e = e26638;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___26679 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5718__auto___26679)){
var seen_errors_26681 = temp__5718__auto___26679;
if(cljs.core.truth_(seen_errors_26681.has(self))){
} else {
seen_errors_26681.add(self);

var temp__5720__auto___26683 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5720__auto___26683)){
var sense_26684 = temp__5720__auto___26683;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_26684)].join('');
} else {
}
}
} else {
