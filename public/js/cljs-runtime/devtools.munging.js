...
var o__26427__auto__ = f;
return (o__26427__auto__["toString"]).call(o__26427__auto__);
} else {
return "";
}
}catch (e29064){var _ = e29064;
return "";
}});
...
try{var o__26427__auto___29241 = t;
(o__26427__auto___29241["cljs$lang$ctorPrWriter"]).call(o__26427__auto___29241,t,writer);
}catch (e29066){var __29242 = e29066;
}
...
var char_code = (function (){var o__26427__auto__ = (new String(char$));
return (o__26427__auto__["charCodeAt"]).call(o__26427__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26427__auto__ = String;
return (o__26427__auto__["fromCharCode"]).call(o__26427__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__29079 = num_code;
switch (G__29079) {
case (1):
return (185);
...
var o__26427__auto__ = String;
return (o__26427__auto__["fromCharCode"]).call(o__26427__auto__,superscript_code);
});
/**
...
}catch (e29112){var _e__26449__auto__ = e29112;
return false;
}})())){
...
var vec__29113 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29113,(0),null);
...
var temp__5718__auto____$1 = (o29120["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o29121 = temp__5718__auto____$1;
return (o29121["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__29124){
var vec__29125 = p__29124;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29125,(0),null);
...
var G__29302 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__29303 = cljs.core.butlast(remaining_tokens);
name_tokens = G__29302;
remaining_tokens = G__29303;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq29122){
var G__29123 = cljs.core.first(seq29122);
var seq29122__$1 = cljs.core.next(seq29122);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29123,seq29122__$1);
});
...
var vec__29130 = cljs.core.split_with((function (p1__29129_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__29129_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29130,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29130,(1),null);
...
var vec__29136 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29136,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29136,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__29324 = cljs.core.rest(remaining_tokens);
var G__29325 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__29324;
name_tokens = G__29325;
continue;
} else {
...
var vec__29150 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29150,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29150,(1),null);
var vec__29153 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29153,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29153,(1),null);
var vec__29156 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29156,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29156,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29156,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29156,(3),null);
...
var vec__29164 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29164,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29164,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29164,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29164,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29164,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29164,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__29170 = temp__5718__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29170,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29170,(1),null);
var vec__29173 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29173,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29173,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__29177 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__29177) : devtools.munging.parse_fn_info_deep.call(null,G__29177));
})()));
}
} else {
return fn_info;
...
var G__29333 = (arity + (1));
var G__29334 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__29178){
var vec__29179 = p__29178;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29179,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29179,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__29183_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__29184_SHARP_);
...
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29188,(0),null);
...
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29186,seq29185__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29192__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29192__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29192__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29192__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__29193 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29193,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29193,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29193,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29193,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29193,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29193,(5),null);
...
var o__26427__auto__ = f;
return (o__26427__auto__["getBasis"]).call(o__26427__auto__);
});
/**
...
}catch (e29203){var _e__26449__auto__ = e29203;
...
var G__29362 = (obj[cljs.core.first(path)]);
var G__29363 = cljs.core.rest(path);
obj = G__29362;
path = G__29363;
continue;
} else {
...
return (function (accum,p__29217){
var vec__29218 = p__29217;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29218,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29218,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__29224){
...
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29225,(2),null);
...
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29230,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29230,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__29230,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__29228_SHARP_){
return (obj[cljs.core.first(p1__29228_SHARP_)]);
});})(name,sorted_matches,vec__29230,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
